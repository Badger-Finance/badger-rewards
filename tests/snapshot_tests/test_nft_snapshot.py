...
def mock_fns(monkeypatch):
    ...
    monkeypatch.setattr("rewards.snapshot.nft_snapshot.get_nft_score", mock_get_nft_score)

    monkeypatch.setattr("rewards.classes.Snapshot.fetch_token_prices", mock_fetch_token_prices)
    monkeypatch.setattr("rewards.classes.Snapshot.send_message_to_discord", mock_send_message_to_discord)
